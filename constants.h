...
const uint16_t ModeTimeoutZWS = 150; //old value of 70 If no additional pulses within this many milliseconds of the first pulse, assume that it was a spurious event and revert to the off state.
